...
// @namespace    https://github.com/chewbie88/wayfarer-plugins/
// @downloadURL  https://github.com/chewbie88/wayfarer-plugins/raw/main/wayfarer-nomination-streetview/wayfarer-nomination-streetview.meta.js
// @updateURL    https://github.com/chewbie88/wayfarer-plugins/raw/main/wayfarer-nomination-streetview/wayfarer-nomination-streetview.user.js
// @homepageURL  https://github.com/chewbie88/wayfarer-plugins/
// @match        https://wayfarer.nianticlabs.com/*
// ==/UserScript==

// Copyright 2024 Chewbi88, tehstone, Tntnnbltn
...
(function() {
    ...
    function addCoordinates(selected) {
        ...
        awaitElement(() => document.querySelector("div.card > p") )
            .then((locationP) => {
        ...
        awaitElement(() => document.querySelector("app-submissions app-details-pane h4"))
            .then((titleP) => {
                ...
                titleP.title = 'Copy title to clipboard';
